            ...
            <div className="prose prose-lg prose-gray max-w-none mb-12">
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: blog.content
                    .replace(/<p>/g, '<p class="mb-6 text-xl leading-relaxed">')
                    .replace(
                      /<h([1-6])>/g,
                      '<h$1 class="font-bold text-4xl text-white mt-8 mb-4">'
                    )
                    .replace(/<ul>/g, '<ul class="mb-6 space-y-2">')
                    .replace(/<ol>/g, '<ol class="mb-6 space-y-2">')
                    .replace(/<li>/g, '<li class="text-lg leading-relaxed">')
                    .replace(
                      /<blockquote>/g,
                      '<blockquote class="border-l-4 border-blue-500 pl-6 py-4 bg-gray-50 rounded-r-lg my-6 italic text-lg">'
                    ),
                }}
              />
            </div>
